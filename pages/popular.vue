...
const { date } = await useFetch("/api/movies/popular", {
  transform: (data) => {
...
<template>
    ...
    <section class="border-b border-slate-300 mb-8">
      <h1 class="text-5xl font-extrabold dark:text-white mb-4">Popular Movies</h1>
    ...
    <section>
      <h1 class="text-5xl font-extrabold dark:text-white mb-4">Popular Series</h1>
      <ul class="grid grid-cols-5 gap-4 justify-items-center">
